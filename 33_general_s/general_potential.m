...
dg_globals.potential_eff_general_s = -(1./(1-dg_globals.capH_double.^2)).*(1-(2*dg_globals.M./dg_globals.r_sch)).*(2*dg_globals.M.*(1+dg_globals.spin_field)./(dg_globals.r_sch.^3) ...

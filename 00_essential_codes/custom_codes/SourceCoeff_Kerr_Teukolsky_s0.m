function [G] = SourceCoeff_Kerr_Teukolsky_s0(dg_globals, theta_p, phi_p)
...
%
%
ell=dg_globals.ell_mode_max;
m=dg_globals.m_mode;
mass_kerr=dg_globals.M;
spin_kerr=dg_globals.a;
mass_particle=dg_globals.mass_particle;
rp=dg_globals.particle.rp_rsch;
